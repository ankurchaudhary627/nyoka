...
class TestMethods(unittest.TestCase):
    ...
    def test_exponentialSmoothing_01(self):
        ...
        mod,res=make_mod_and_res_obj(ds,t='add',d=False,s='add',sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='add',d=True,s='mul',sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='add',d=False,s='mul',sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='mul',d=True,s='add',sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='mul',d=False,s='add',sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='mul',d=True,s='mul',sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
    ...
    def test_exponentialSmoothing_02(self):
        ...
        mod,res=make_mod_and_res_obj(ds,t='add',d=True,s=None,sp=None)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='add',d=False,s=None,sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='add',d=False,s=None,sp=None)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='mul',d=True,s=None,sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='mul',d=True,s=None,sp=None)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='mul',d=False,s=None,sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
        
        mod,res=make_mod_and_res_obj(ds,t='mul',d=False,s=None,sp=None)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
    ...
    def test_exponentialSmoothing_03(self):
        ...
        mod,res=make_mod_and_res_obj(ds,t=None,d=False,s=None,sp=2)
        ExponentialSmoothingToPMML(ds, mod,res, f_name)
        self.assertEqual(os.path.isfile(f_name),True)
        os.remove(f_name)
